...
curl -o .repo/local_manifests/manifest_brcm_rpi.xml -L https://raw.githubusercontent.com/willfarris/android_kernel_manifest/android-16.0/manifest_brcm_rpi.xml --create-dirs
```
